...
# read the json file
file_path = "results/locomo/openclaw/openclaw_locomo_judged.json"

with open(file_path, encoding="utf-8") as f:
    data = json.load(f)

# category mapping for locomo
category_mapping = {1: "multi hop", 2: "temporal reasoning", 3: "open domain", 4: "singel hop"}
...
print(f"{'Category':<10} {'Category Name':<20} {'Questions':<10} {'Correct':<10} {'Accuracy':<10}")
print("-" * 70)
